function e(e,t,o,n){Object.defineProperty(e,t,{get:o,set:n,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},n={},i=t.parcelRequire1770;null==i&&((i=function(e){if(e in o)return o[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return o[e]=i,t.call(i.exports,i,i.exports),i.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){n[e]=t},t.parcelRequire1770=i),i.register("27Lyk",function(t,o){e(t.exports,"register",()=>n,e=>n=e),e(t.exports,"resolve",()=>i,e=>i=e);var n,i,a={};n=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)a[t[o]]=e[t[o]]},i=function(e){var t=a[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),i.register("fYx2c",function(e,t){e.exports=new URL(i("27Lyk").resolve("6nUhZ"),import.meta.url).toString()}),i.register("1LekW",function(e,t){e.exports=new URL(i("27Lyk").resolve("k0E3k"),import.meta.url).toString()}),i.register("wF6Ju",function(e,t){e.exports=new URL(i("27Lyk").resolve("6ocGL"),import.meta.url).toString()}),i("27Lyk").register(JSON.parse('{"dZpbI":"index.5375463e.js","6nUhZ":"tijera.3914bd3c.png","k0E3k":"piedra.b149aa9e.png","6ocGL":"papel.2b93aab3.png"}'));const a={data:[],listeners:[],getState(){return this.data},suscribe(e){this.listeners.push(e)},setState(e){for(let t of(this.data=e,this.listeners))t()},addItem(e=[]){let t=this.getState();console.log("addItem currenState:",t),console.log("item",e);let o=[...t,e];this.setState(o)}},r=[{path:/\/inicio/,component:function(e){let t=document.createElement("div");t.className="contenedor-inicio",t.innerHTML=`
...
`;let o=t.querySelector(".mi-button");return o?.addEventListener("click",()=>{e.goTo("/instrucciones")}),t}},{path:/\/instrucciones/,component:function(e){let t=document.createElement("div");t.innerHTML=`
  ...
  `,e}},{path:/\/ganaste/,component:function(e){let t=document.createElement("div");t.innerHTML=`
    ...
    `;let o=t.querySelector(".mi-button");return o?.addEventListener("click",()=>{e.goTo("/instrucciones")}),t}}],s="/piedra-papel-tijera";function l(){return location.host.includes("ezequielgimenez.github.io")}!function(){let e=document.querySelector(".root");!function(e){function t(e){let t=l()?s+e:e;history.pushState({},"",t),o(t)}function o(o){let n=l()?o.replace(s,""):o;for(let o of r)if(o.path.test(n)){let n=o.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}}"/"==location.pathname||"/piedra-papel-tijera/"==location.pathname?t("/inicio"):o(location.pathname),window.onpopstate=()=>{o(location.pathname)}}(e),customElements.define("el-texto",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("link");t.setAttribute("href","https://fonts.googleapis.com/css2?family=Odibee+Sans&display=swap"),t.setAttribute("rel","stylesheet"),e.appendChild(t);let o=this.getAttribute("tipoTexto")||"",n=document.createElement("div");n.className=o,n.textContent=this.textContent,e.appendChild(n);let i=document.createElement("style");i.textContent=`
            .title{
                font-size:80px;
                color:#009048;
                text-align: center;
        ...
        `,e.appendChild(a)}}),customElements.define("perdiste-comp",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div"),o=localStorage.getItem("resultados"),n=JSON.parse(o??"null");t.className="contenedor-imgLose",t.innerHTML=`
          ...
          `,e.appendChild(a)}})}();
//# sourceMappingURL=index.5375463e.js.map
