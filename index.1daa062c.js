function e(e,t,o,n){Object.defineProperty(e,t,{get:o,set:n,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},o={},n={},i=t.parcelRequire1770;null==i&&((i=function(e){if(e in o)return o[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return o[e]=i,t.call(i.exports,i,i.exports),i.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){n[e]=t},t.parcelRequire1770=i),i.register("27Lyk",function(t,o){e(t.exports,"register",()=>n,e=>n=e),e(t.exports,"resolve",()=>i,e=>i=e);var n,i,r={};n=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)r[t[o]]=e[t[o]]},i=function(e){var t=r[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),i.register("5UesL",function(e,t){e.exports=new URL(i("27Lyk").resolve("74Trf"),import.meta.url).toString()}),i.register("9gay6",function(e,t){e.exports=new URL(i("27Lyk").resolve("57tS2"),import.meta.url).toString()}),i.register("k7DIM",function(e,t){e.exports=new URL(i("27Lyk").resolve("axSNX"),import.meta.url).toString()}),i("27Lyk").register(JSON.parse('{"1LzKV":"index.1daa062c.js","74Trf":"tijera.3914bd3c.png","57tS2":"piedra.b149aa9e.png","axSNX":"papel.2b93aab3.png"}'));const r={data:[],listeners:[],getState(){return this.data},suscribe(e){this.listeners.push(e)},setState(e){for(let t of(this.data=e,this.listeners))t()},addItem(e=[]){let t=this.getState();console.log("addItem currenState:",t),console.log("item",e);let o=[...t,e];this.setState(o)}},a=[{path:/\/inicio/,component:function(e){let t=document.createElement("div");t.className="contenedor-inicio",t.innerHTML=`
  ...
  `,e}},{path:/\/ganaste/,component:function(e){let t=document.createElement("div");t.innerHTML=`
    ...
    `;let o=t.querySelector(".mi-button");return o?.addEventListener("click",()=>{e.goTo("/instrucciones")}),t}}],s="desafio-m5";function l(){return location.host.includes("github.io")}!function(){let e=document.querySelector(".root");!function(e){function t(e){let t=l()?s+e:e;history.pushState({},"",t),o(t)}function o(o){let n=l()?o.replace(s,""):o;for(let o of a)if(o.path.test(n)){let n=o.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}}"/"==location.pathname?t("/inicio"):o(location.pathname)}(e),customElements.define("el-texto",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("link");t.setAttribute("href","https://fonts.googleapis.com/css2?family=Odibee+Sans&display=swap"),t.setAttribute("rel","stylesheet"),e.appendChild(t);let o=this.getAttribute("tipoTexto")||"",n=document.createElement("div");n.className=o,n.textContent=this.textContent,e.appendChild(n);let i=document.createElement("style");i.textContent=`
        ...
        `,e.appendChild(o)}}),customElements.define("ppt-play",class extends HTMLElement{constructor(){super(),this.count=3,this.arrayDeValores=[],this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){let e=document.createElement("div"),t=i("5UesL"),o=i("9gay6"),n=i("k7DIM");e.innerHTML=`
          ...
          `,this.shadow.appendChild(a);let s=this.shadow.querySelectorAll(".mi-img"),l=this.shadow.querySelector(".contenedor-img"),c=!1;s.forEach(e=>{e.addEventListener("click",()=>{c=!0;let t=e.getAttribute("data-valor");s.forEach(t=>{t!==e&&(t.style.display="none",l.style.justifyContent="center")}),console.log("data-valor",t),null!==t&&this.arrayDeValores.push(t),r.addItem(this.arrayDeValores)})});let d=this.shadow.querySelector(".counter"),m=setInterval(()=>{d&&(d.textContent=this.count.toString(),this.count--,this.count<0&&(clearInterval(m),c||(console.log("No se hizo clic en ninguna imagen y el contador lleg\xf3 a cero."),window.location.href="/instrucciones"),d.remove(),this.showRandomImage()))},1e3)}showRandomImage(){let e=[],t=this.shadow.querySelectorAll(".img-random"),o=this.shadow.querySelector(".maquina"),n=document.createElement("div");n.className="contenedor-maquina";let i=document.createElement("style");t.forEach(t=>{let o=t.getAttribute("src"),n=t.getAttribute("valor");null!==o&&null!==n&&e.push({src:o,data:n})}),console.log(e);let a=Math.floor(Math.random()*e.length),s=e[a],l=e[a].src,c=e[a].data;console.log("array de la imagen [0]",s),console.log(l),console.log(c);let d=this.shadow.querySelector(".img-random");null!==d&&(d.src=l,d.setAttribute("valor",c));let m=d.getAttribute("valor");null!==m&&this.arrayDeValores.push(m),r.addItem(this.arrayDeValores),n.innerHTML=`
        ...
        `,e.appendChild(r)}}),customElements.define("perdiste-comp",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div"),o=localStorage.getItem("resultados"),n=JSON.parse(o??"null");t.className="contenedor-imgLose",t.innerHTML=`
          ...
          `,e.appendChild(r)}})}();
//# sourceMappingURL=index.1daa062c.js.map
