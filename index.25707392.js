  ...
  `,e}},{path:/\/ganaste/,component:function(e){let t=document.createElement("div");t.innerHTML=`
    ...
    `;let o=t.querySelector(".mi-button");return o?.addEventListener("click",()=>{e.goTo("/instrucciones")}),t}}],s="/piedra-papel-tijera";function l(){return location.host.includes("github.io")}!function(){let e=document.querySelector(".root");!function(e){function t(e){let t=l()?s+e:e;history.pushState({},"",t),o(t)}function o(o){let n=l()?o.replace(s,""):o;for(let o of a)if(o.path.test(n)){let n=o.component({goTo:t});e.firstChild&&e.firstChild.remove(),e.appendChild(n)}}"/piedra-papel-tijera/"==location.pathname?t("/inicio"):o(location.pathname),window.onpopstate=()=>{o(location.pathname)}}(e),customElements.define("el-texto",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("link");t.setAttribute("href","https://fonts.googleapis.com/css2?family=Odibee+Sans&display=swap"),t.setAttribute("rel","stylesheet"),e.appendChild(t);let o=this.getAttribute("tipoTexto")||"",n=document.createElement("div");n.className=o,n.textContent=this.textContent,e.appendChild(n);let i=document.createElement("style");i.textContent=`
        ...
        `,e.appendChild(r)}}),customElements.define("perdiste-comp",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("div"),o=localStorage.getItem("resultados"),n=JSON.parse(o??"null");t.className="contenedor-imgLose",t.innerHTML=`
          ...
          `,e.appendChild(r)}})}();
//# sourceMappingURL=index.25707392.js.map
